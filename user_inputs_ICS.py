...
class User_Inputs:
    ...
    ##########################################
    def org_path(number):
        original_file_path = input('Enter full file path of'\
    ...
    def hp_question():
        ...
        HP_option= fixed_data_ICS.Fixed_Data.HP_option
        
        while True:
            HP_dec=input('Please Enter (Y/N) for HP Drives'
                         ' selection:')
    ...
    def fw_type():
        ...
        while True:
                fw_type= input('Is it a Q: Qualification or'\
                              ' R: Regression of HDD Firmware? :')
                fw_type=str(fw_type)
    ...
    def hdd_model(HP_dec):
        ...
        while flag==0:
            if HP_dec=='N':
                model_no= input('Please enter a Valid HDD Model'\
                                ' No. : ')
                for i in range(len(model_list)):
                    if str(model_no)==model_list[i]:
                        ...
                        if flag == 0:
                            print('\nInvalid Model No.,'\
                            'Please enter a HDD Valid Model No.\n') 
                        else:
                            print('\nValid HDD Model No.\n')
    ...
    def chassis_in(f1):
        ...
        while True:
            i1=input('Please select a number for a Chassis'\
                    ' of File #' +str(f1+1)+ ' : ' )
            i1=int(i1)
    ...
    def cntrller_in(f1):
        ...
        while True:
            i1=input('Please select a number for a Controller'\
                     ' of File # ' +str(f1+1)+ ' : ' )
            i1=int(i1)
    ...
    ########################################## 
    def word_in():
        word_file=input('Please enter full path of Word Template:')
